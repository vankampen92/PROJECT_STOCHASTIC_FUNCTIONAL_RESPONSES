...
Stressed Induced Mortality (i.e., presence of antibiotics) & $\delta^{(R)}_1$ & 0.01 & 10.00 & 0.25\\
Resource Local Reproduction Rate & $\beta_R$ & 0.01 & 10.00 & 4.00\\
Comsumer Attack Rate (0) & $\alpha^{(C)}_0$ & 0.00 & 0.50 & 0.80\\
Resistance to Stress (confered by a plasmid) & $\nu^{(C)}_0$ & 0.00 & 50.00 & 0.40\\
...
Plasmid Transmission Probability (upon encounter and conjugation) & $\chi^{(C)}_0$ & 0.00 & 2.00 & 0.70\\
Segregation Error at Reproduction & $p_1$ & 0.00 & 100.00 & 0.00\\
Probablity of Competition-Induced Death (upon encounter) & $p_2$ & 0.00 & 1000.00 & 0.08\\
\hline\hline
\end{tabular}
