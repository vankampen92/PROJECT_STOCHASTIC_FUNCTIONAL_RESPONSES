...
void Model_Variables_Code_into_Parameter_Table (Parameter_Table * Table)
{
  ...
  case 22: /* ECO_1B1P * * * * * * * * * * */
    ...
    */
    ...
    case 23: /* ECO_1B1P_SELF * * * * * * * * * * */

    /* No_of_EVENTS, i.e, common events that can occur to every species: */
    Table->No_of_EVENTS = 6;  /* All species (strains or phenotypes) can undergo the 
                                same 6 processes (Outmigration, Immigration, Death, Competition-induced Death, 
                                Self-Competition-induced Death, and Cell Division) */
    Table->TOTAL_No_of_EVENTS = Table->No_of_EVENTS * Table->No_of_RESOURCES + 2;  /* 14 Events */
